...
<template>
  ...
  >
    <div class="bg-surface rounded-lg shadow-xl border border-border-subtle max-w-md w-full p-6">
      <h2 class="text-lg font-semibold mb-1 text-text-primary">Move to album</h2>
      <p class="text-sm text-text-muted mb-4">
        Pick the album to move this photo to. Only your other albums are shown.
      </p>
      ...
      <ul v-else class="max-h-60 overflow-y-auto divide-y divide-border-subtle">
