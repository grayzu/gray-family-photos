...
async function save() {
  ...
  try {
    ...
    if (location.value) {
      ...
      if (location.value.countryCode)
        body.locationCountry = location.value.countryCode;
    }
  ...
  <Transition name="modal">
    ...
    >
      ...
      >
        ...
        <p v-if="error" class="text-sm text-coral mb-3" data-test="edit-error">
          {{ error }}
        </p>
